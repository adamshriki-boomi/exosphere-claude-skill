---
id: "components-segmented-control--overview"
title: "Components/Segmented Control"
name: "Overview"
source_url: "https://exosphere.boomi.com/iframe.html?id=components-segmented-control--overview&viewMode=docs"
scraped_at: "2026-04-21T08:43:47.876Z"
...
| Name | Description |
| --- | --- |
| \--exo-component-segmented-control-width | Token to adjust the width of the component. |
...
-   Usage:
    ...
    .your-class-name {
    \--exo-component-segmented-control-width: 50px;
    }
...
for default selected segmentedcontrol
...
Segment controls color variant
