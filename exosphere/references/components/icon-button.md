---
id: "components-icon-button--overview"
title: "Components/Icon Button"
name: "Overview"
source_url: "https://exosphere.boomi.com/iframe.html?id=components-icon-button--overview&viewMode=docs"
scraped_at: "2026-04-21T08:43:31.889Z"
...
branded
 ...
 | `one of: base | branded | risky | periwinkle | periwinkle_green` |
| size | 
...
default
 ...
 | `one of: default | small | x-small` |
| circular | 

Icon button rendered as a circle
...
Icon button state is disabled or not
...
Custom native tooltip label for the icon in ex-icon-button (used for aria-label)
...
Controls the notification indicator. Attribute: 'true' (dot), number (count), 'false' (hide). Property: true (dot), number (count), false/0/undefined (hide).
...
### With Indicator: Count (Below Max)

### With Indicator: Count (9+)

### On State Styling

#### On State Styling (Only works with BRANDED + SECONDARY/TERTIARY)

#### On State Won't Apply (Wrong flavor/type combinations)
