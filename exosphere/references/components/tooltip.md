---
id: "components-tooltip--overview"
title: "Components/Tooltip"
name: "Overview"
source_url: "https://exosphere.boomi.com/iframe.html?id=components-tooltip--overview&viewMode=docs"
scraped_at: "2026-04-21T08:43:58.288Z"
...
--exo-component-tooltip-arrow-size           | Token to modify arrow size of tooltip.
--exo-component-tooltip-arrow-size-diagonal  | Token to modify size of diagonal-arrow tooltip.
--exo-component-tooltip-arrow-padding-offset | Token to modify padding-offset of tooltip.
...
| --- | --- | --- | --- |
| tooltipDelay | 
Delay time in seconds before showing the tooltip.
...
Refers to the side of the tooltip which the pointer will be placed.
...
Within the position side, refers to how the pointer is aligned.
...
If true, the tooltip text will wrap to the next line if it is too long.
...
Render tooltip in document body portal to prevent cropping by parent containers with transform or overflow hidden.
...
When true, clicking on the tooltip popup will not close it. Only clicks outside will close the tooltip.
...
There are 2 general variants that tooltips and toggletips can have:

1.  Pointer position
2.  Alignment

The mixed state is only applied when a checkbox is a parent to at least 2 child checkboxes with differing checked or unchecked states.

Pointer position:

Refers to the side of the tooltip which the pointer will be placed. Options include:
...
![](../../../docs/assets/images/tooltip/position.png)

Pointer alignment:

Within the position side, refers to how the pointer is aligned. Options include:

1.  Start
2.  Middle
3.  End

![](../../../docs/assets/images/tooltip/alignment.png)

Examples

Tooltips can be used to display additional contextual information for things like:

1.  Overflow text
2.  Icon buttons (must have tooltips accompanying)
3.  Info text
...
Duis autre irure dolor in reprehenderit in voluptate v Duis autre irure dolor in reprehenderit in voluptate v
