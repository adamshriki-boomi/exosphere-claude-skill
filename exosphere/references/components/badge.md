---
id: "components-badge--overview"
title: "Components/Badge"
name: "Overview"
source_url: "https://exosphere.boomi.com/iframe.html?id=components-badge--overview&viewMode=docs"
scraped_at: "2026-04-21T08:43:16.175Z"
built_at: "2026-04-21T08:48:27.289Z"
---
### Badge

The Badge component provides a styled label element, with support for color, shape, and icon options. It can be used to display categorized information or statuses.
...
<ex-badge color="blue" shape="round" size="default" showicon="" icon="integration">Integration</ex-badge>
...
| Property | Description | Default Value | Control Type |
| --- | --- | --- | --- |
| **color** | Refers to the color variant of the Badge | `BadgeColor.BLUE` | select |
| **icon** | Icon to display inside the Badge | `" "` | select |
| **shape** | Badge shape, either `round` or `square` | `BadgeShape.ROUND` | select |
| **size** | Badge size | `BadgeSize.DEFAULT` | select |
| **showIcon** | Shows a prefix icon on the Badge if set to true | `true` | boolean |
...
| --- | --- | --- | --- |
| color | 
Refers to the color variant of the Badge
...
If true, the tooltip text will wrap to the next line if text is too long.
...
If true, the badge will use the text content as the label.
...
Custom native tooltip label for the icon in ex-badge
...
Gray Red Navy Green Yellow Blue Orange White
...
Badges that are longer than 24 characters, the Badge will be truncated with a tooltip on hover. The task is due and need to be closed by end of the year.
