---
id: "components-tree--overview"
title: "Components/Tree"
name: "Overview"
source_url: "https://exosphere.boomi.com/iframe.html?id=components-tree--overview&viewMode=docs"
scraped_at: "2026-04-21T08:43:59.723Z"
...
| Name | Description |
| --- | --- |
| \--exo-component-tree-child-padding-left | Token to modify padding of the left tree-child. |
...
-   Usage:
    ...
    .your-class-name {
    \--exo-component-tree-child-padding-left: calc(
      var(\--parent-padding-left) + var(\--exo-spacing-large)
    );
    }
...
| --- | --- | --- | --- |
| treeData | 
The hierarchical data structure used to render the tree.
...
Displays checkboxes for each tree node.
...
Allows editing the tree node label on double-click.
...
Displays connector lines between tree nodes.
...
Displays an icon for each tree node.
...
Displays a dropdown menu for each tree node.
...
Enables drag and drop for reordering tree nodes.
...
Sets the height of each tree node. Options include 'medium' and 'large'.
...
medium
 ...
 | `one of: medium | large` |
| showDefaultMenuActions | 

Shows default dropdown actions like 'Rename' and 'option'.
...
Fires when a tree node is clicked by the user.
...
Custom native tooltip label for the collapse icon.
...
Custom native tooltip label for the expand icon.
...
Custom native tooltip label for the reorder (drag handle) icon.
...
Custom action items to be shown in the node dropdown menu.
...
Fires when a dropdown action is selected for a tree node.
