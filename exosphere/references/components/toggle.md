---
id: "components-toggle--overview"
title: "Components/Toggle"
name: "Overview"
source_url: "https://exosphere.boomi.com/iframe.html?id=components-toggle--overview&viewMode=docs"
scraped_at: "2026-04-21T08:43:57.176Z"
...
| Name | Description |
| --- | --- |
| \--exo-component-toggle-label-gap | Token to modify gap of toggle label |
...
-   Usage:
    ...
    .your-class-name {
    \--exo-component-toggle-label-gap: 2px;
    }
...
Toggle state is disabled or not
...
Toggle is externally controlled or not
...
Custom native tooltip label for the left icon in ex-toggle
...
Custom native tooltip label for the right icon in ex-toggle
