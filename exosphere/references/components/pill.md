---
id: "components-pill--overview"
title: "Components/Pill"
name: "Overview"
source_url: "https://exosphere.boomi.com/iframe.html?id=components-pill--overview&viewMode=docs"
scraped_at: "2026-04-21T08:43:41.593Z"
...
| --- | --- | --- | --- |
| color | 
Refers to the color variant of the Pill
...
gray
 ...
 | `one of: gray | red | aqua | navy | green | yellow | blue` |
| size | 
...
Adds a remove button to the Pill
...
The onremove event with element removed element.
...
Custom native tooltip label for the leading icon in ex-pill
...
Pills have the following options (you can pick and choose what your pills will have):
...
-   Green
-   Blue
-   Yellow (Should only be used for errors)
-   Red (Should only be used for failures / negative)Important interaction details
    

Normal Error! Integration Success Integration Integration Warning!

No Prefix Icon

It is up to your discretion whether you want to display prefix icons or not. Please strongly consider using icons for pills that display statuses (success, warning, failure)

Integration

No removal handler

Removal handler should be used in cases where pills need to be added or removed. These only exist for interactive pills.

Integration

Truncation + tooltip

For pills that are longer than 24 characters, the pill will be truncated with a tooltip on hover.

The task is due and need to be closed by end of the year.
